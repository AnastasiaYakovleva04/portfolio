...
const works = [
    ...
    },
    {
        ...
        desc: "командный проект - одностраничный сайт для нко, специализирующейся на рекультивации карьеров и создании рыбоводных экосистем в Бурятии. динамическая загрузка последних новостей из вк-сообщества. адаптивный дизайн в минималистичном стиле с bento-сеткой и мягкой цветовой палитрой",
        date: "октябрь-ноябрь 2025",
        stack: "разработка на tilda + html, css, js", 
